class BankAccount {
    constructor(accountNumber, accountNumber, balance) {
        this.accountNumber = accountNumber;
        this.accountHolderName = this.accountHolderName;
        this.balance = balance;
    }
    deposite(amount) {
        this.balance += amount;
        console.log(`Ammount $${amount} deposite into account ${this.accountNumber}.`);
    }
    ...
    transfer(amount, recipientAccount) {
        if (amount <= this.balance) {
            this.balance -= amount;
            recipientAccount.deposite(amount);
            console.log(`AMount $${amount} transferred form account ${this.accountNumber} to account ${recipientAccount.accountNumber}.`);
        } else {
